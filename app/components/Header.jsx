    ...
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <div>
                ...
                <p className="max-w-2xl mx-auto font-Ovo">I am a Software Engineer from Depok, Indonesia. To stay update with technological developments, I always learn new things. Like how to become a Front End Developer and on the sidelines of time, I usually make work with creative applications 😄. </p>
